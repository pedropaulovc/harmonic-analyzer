...
**`rocker-arm-support`** foot holes — 4× 9/16-12, tap drill Ø12.30. **The only real threads in the entire machine.** Then the 20× Ø2.0 spring holes in the summing lever at 7.0565 mm pitch.

## Competency check

A four-hole pattern within 0.1 mm true position, and a 9/16-12 thread cut clean without a broken tap.

## Notes

Almost nothing in this machine is threaded and there are no keyways at all — gears are soldered or run free on an arbor. That simplifies the build enormously.
