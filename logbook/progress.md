...
| part | qty needed | qty made | qty scrapped | first entry |
|---|---:|---:|---:|---|
| — | | | | |
...
The book's credibility and the campaign's both depend on this log updating
visibly and regularly. One entry per session, published as it happens.
