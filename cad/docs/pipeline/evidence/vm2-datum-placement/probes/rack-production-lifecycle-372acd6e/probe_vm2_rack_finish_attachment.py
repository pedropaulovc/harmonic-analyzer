...
Attach only; do not save. By default, neither edit annotations nor close the failed drawing.
...
def main():
    ...
    if args.save_reopen and (not args.saved_candidate or not args.point_trials):
        parser.error("--save-reopen requires --saved-candidate and --point-trials")
    ...
    async def probe(adapter):
        ...
        report = {"kind": "vm2-rack-finish-attachment-control", "status": "running",
                  ...
                  "mode": "reattach_failed" if args.reattach_failed else "close_failed" if args.close_failed else "read_only",
                  "observations": []}
        ...
        try:
            ...
            if args.reattach_failed:
                ...
                if args.point_trials:
                    ...
                    if args.save_reopen:
                        ...
                        observe(failed, "after_point_trials_cold_reopen")
            ...
            report.update(status="closed_without_save" if args.close_failed else "reattach_observed" if args.reattach_failed else "read_only_complete", source_sha256_after=digest(source),
