...
| MHA-013 cone gear T006 | Root-to-bore web 0.606 mm (printed MIN floor Ø2.849 to the Ø1.6375 maximum bore), under the 1.5 floor. | Book fidelity: the 6-tooth gear's floor sits at r 1.42, and no usable bore meets 1.5 under it. The 1/16 in bore is the shaft's smallest land, and an integral pinion is blocked by the tip-first assembly. T012–T024 meet the 2.0 target on smaller lands. | User, U40, 2026-09-23; amended by the user's C2 ruling 2026-09-26 (floor MIN 2.880 → 2.849 to keep a 0.04 window under the #917 fit-up residual) |
| MHA-013 cone gears T006–T048, in mesh with MHA-027 | Worst-case transverse contact ratio with the 120T drum below 1.1: 0.13 / 0.38 / 0.55 / 0.69 / 0.81 / 0.90 / 0.99 / 1.06 (T006 → T048), every printed band and the #917 fit-up residual at its worst case. | Book fidelity: the tooth counts and taper are the book's (ch12 p.16 shows the wear). The mesh is deepened to the limit, where the tooth comes to a point first. Below CR 1 the drive rides on a tooth-tip corner. Rigid transmission error is ≤ 0.023 mm at the drum pitch line on T006 and ≤ 0.004 elsewhere, so the cost is tip-corner wear, not position error. | User, U42, 2026-09-23; T048 added by the user's #917 R3 ruling, 2026-09-26 |
