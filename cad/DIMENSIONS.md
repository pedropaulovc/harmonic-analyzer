...
| Crank-drive gear (dark steel gear at the large end, "This gear engages the crank" p.20) | coarser pitch than the train, est. DP 16: ~64T, PD 4" (OD ≈ 104.8 mm — now LARGER than the cone 120T's 62.2, no longer a visual match); mates a ~16T crank pinion (4:1) | — | p.20 annotation + visibly coarser teeth than the 120T beside it. With the cone 120T re-anchored to OD 62.2 the old "OD ≈ cone 120T" cross-check is VOID (the 64T at DP 16 is unchanged and now visibly larger than the cone big-end); tooth counts NOT countable in available photos — est. from the stated 4:1 + round-PD argument (see Appendix C #9) | scaled | low |
...
| 64T drive gear | perpendicular on the 3/8" pivot journal at shaft station 19.9, centre (x, z) = (+15.67, −68.62), 0.1 air to the T120 south face | p.20 (directly beside the 120T); its contact tooth (toward the crank) sits 50.8·sin i = 11.0 north of centre at z = −57.61 (the 64T is DP 16, unchanged size, but rides the inboard-shifted cone) | low |
...
| Crankshaft | along Z at (x, y) = (+80.18, 76) = 64T contact x (15.67 + 50.8 cos i) + 63.5 DP 16 centre distance + oblique backoff (pinion centred on the 64T contact-tooth plane z −57.61; the 64T/16T pair is DP 16, unchanged — only its x shifted inboard with the cone) | FLAG: the front-view pedestal at +122 ± 3 NO LONGER matches the derived +80.18 — the smaller cone pulled the 64T (and thus the crank) ~38 mm inboard. This is a new discrepancy from the 62.2 OD anchor: either the crank pedestal photo position or the 62.2 reading is wrong (appendix C #9 pair no longer ratifies) | low |
