...
| Cylinder arbor (stationary) | x = −47.5 (= 55.6 − 101.6 − 1.5 backlash), y = 76, along Z | mesh distance at T120 minus 1.5 mm drum backlash: a straight cone meshing a straight drum engages 0.15 mm/station deeper toward the small end (plan-projected radius shrinks by cos 19.8° while the x-step stays 2.54), so ideal big-end distance interferes at T036..T006 (live check); the book's "oblique partial engagement" note (ch. 12) is this same geometry. Vertical connecting rods reach rocker tips only for x_cyl ≥ −100 ✓ | med |
