...
- **SinusoidalCam.cs**: Main SolidWorks C# macro file
- **README.md**: This documentation file

## How to Use

### Option 1: Run as a VSTA Macro in SolidWorks
...
### Option 2: Copy Code to Existing Macro
...
### Option 3: Use in a SolidWorks Add-in

The code can be integrated into a SolidWorks add-in by:
1. Copying the `CreateEccentricCam()` method
