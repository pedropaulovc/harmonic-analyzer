...
DRAWING_NOTES = "\n".join(
    (
        "ONE STRAP SHOWN. OUTER R9.00 ARCS ARE BASIC, CENTRED ON BORE AXES;",
        "  STRAIGHT SIDES BASIC-TANGENT. PROFILE OF ENTIRE OUTLINE 0.10.",
        "PIN-SEAT AXIS IS 2.00+/-0.05 BELOW PIVOT AXIS AND AT MID-THICKNESS.",
        "  BOTTOM PLANE 5.00+/-0.05 LEFT OF PIVOT AXIS; 3.50 MIN FULL-DIAMETER",
        "  4.000-4.012 ENGAGEMENT. FLAT-BOTTOM OR RELIEVE DRILL POINT; PRESS FIT PIN.",
        "MAKE TWO IN ONE FIXTURE AND MATCH-MARK. WITH MATING FACES CLAMPED FLUSH,",
        "  GAGE-PIN AXIS MISMATCH AT EITHER BORE 0.03 MAX; FACE MISMATCH 0.05 MAX.",
    )
)
