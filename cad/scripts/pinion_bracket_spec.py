...
DRAWING_NOTES = "\n".join(
    (
        "STRAP ENDS ROUNDED ON A COMMON <MOD-DIAM>18 WIDTH; BOTH BORES ON THE CENTRELINE.",
        "PIVOT AND ARBOR BORES: REAM THRU;",
        "RUNNING FIT ON THE <MOD-DIAM>6.35 TORQUE SHAFT AND <MOD-DIAM>8 ARBOR.",
        "PIN SEAT: <MOD-DIAM>4 DRILL 4 DEEP FROM THE SIDE EDGE (SEE RIGHT VIEW),",
        "FLAT BOTTOM; PRESS FIT FOR THE <MOD-DIAM>4 CAM-FOLLOWER PIN.",
        "2 STRAPS REQUIRED; MACHINE IN ONE SETUP FOR MATCHED BORE CENTRES.",
    )
)
