r"""Create the one-sheet Front/Right/Isometric drive-train assembly drawing."""
...
from _drawing_common import DrawingOutputs, run_drawing_build
...
SHEET_SCALE = (1.0, 3.0)
FRONT_CENTER = (0.060, 0.165)
RIGHT_CENTER = (0.190, 0.165)
