...
Layout: rod axis Z, z 0..207; pins along -Y at z 35.5 and 190.5, axis
...
ROD_LEN = 207.0  # machine z -113..+94: front end proud for the lever root (derived)
PIN_DIA = 4.0  # cam pin, photo-scaled vs the rod (low)
PIN_TIP = 11.175  # rod axis to pin tip -- tip at machine y 51.625 (derived)
PIN_STATIONS = (35.5, 190.5)  # machine z -+77.5: mid-thickness of each strap
