...
LIFT_BORE_DROP = 5.17527222393921  # drum-side support closure. With the lift
# bore 12.5 mm toward the pinion, this drop puts the eccentric collar beneath
# the follower and gives exactly 0.15 mm parked air. The block retains >3.6 mm
# below the reamed bore to the base seat.
