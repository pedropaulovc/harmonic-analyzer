...
- One part or a handful, on a manual mill and lathe with DROs, checked with a
  rule, calipers, a micrometer, pin gauges and a dial indicator. No CMM.
...
- blockers: what stops you making or checking the part — a feature with no
  ...
  cannot tell the unit or the process of. Nothing else goes here.
