...
# #3-48 x 8 screw; 8:1 draws the 10 mm length as 80 mm and the head OD (4.8)
# as ~38 mm.
SHEET_SCALE = (8.0, 1.0)
_S = SHEET_SCALE[0] / 1000.0  # sheet meters per model mm

# Authored on the Top plane, axis +Y: head at y in [0, HEAD_T] (top), shank at
...
_HEAD_END_Y = _side_y(HEAD_T)  # head outer face (top)
...
END_DIM_X = 0.030
END_KEEP = {
    "HeadDiaDim": (END_DIM_X, END_CENTER[1] + 0.028),
}
