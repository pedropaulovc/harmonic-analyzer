...
DRAWING_NOTES = "\n".join(
    (
        ...
        "DATUM C IS ADJUSTER-ENTRY FACE; D IS 12 DEPTH MEDIAN PLANE.",
        ...
        f"SHAFT CLEARANCE PASSAGE DIA {SHAFT_PASSAGE_DIA:.2f} THRU; POSITION",
        "CONTROL APPLIES TO THREAD + PASSAGE COMMON AXIS; PASSAGE IS NOT",
        "A SHAFT-BEARING SURFACE.",
        f"DRILL DIA {PINCH_CLEARANCE_DIA:.3f} +0.10/-0.00 THRU ENTRY-SIDE JAW",
        f"TO SLOT; TAP {PINCH_THREAD} UNC-2B THRU OPPOSITE JAW; COMMON AXIS.",
        ...
        "BOTTOM R0.20 MAX; SLOT CENTERED ON DATUM B WITHIN 0.05.",
    )
)
