...
DRAWING_NOTES = "\n".join(
    (
        ...
        f"  SPHERICAL CROWN SR{CAP_RADIUS:.2f}+/-0.10 X 2.00+/-0.10 HIGH.",
        "CROWN ROOT CIRCLE IS AN INTENTIONAL PROFILE BREAK; DO NOT BLEND.",
        "TRANSVERSE BODY-HOLE AXIS AT GRIP MID-LENGTH WITHIN 0.05; AXIS",
        "  INTERSECTS A WITHIN <MOD-DIAM>0.05 AND IS PERPENDICULAR TO A WITHIN 0.05.",
