...
# ARBOR_Z0, pinned by test); the station is that position from the head rear
# face, so it follows the face whenever the head changes and the drum itself
# never moves in the world.
DRUM_FRONT_Z_AS_BUILT = 60.0
