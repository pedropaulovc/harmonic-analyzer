...
DRAWING_NOTES = "\n".join(
    (
        f"{THREAD_DESIGNATION} FULL THREAD OVER {SHANK_LEN:g} LENGTH BELOW KNOB; "
        "THREAD FORM, RUNOUT, AND LIMITS PER ASME B1.1.",
        "THREAD GEOMETRY OMITTED IN VIEWS; CYLINDRICAL SHANK OUTLINE IS "
        "REFERENCE ONLY.",
        f"KNOB Ø{KNOB_DIA:g} X {KNOB_LENGTH:g} LONG; {GROOVE_COUNT} EQUALLY "
        "SPACED AXIAL Ø1.0 CYLINDRICAL GROOVES, CUTTER AXIS ON KNOB OD, FULL "
        "KNOB LENGTH.",
    )
)
