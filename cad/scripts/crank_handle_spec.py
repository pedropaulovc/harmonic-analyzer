...
DRAWING_NOTES = "\n".join(
    (
        "TURN FROM CLOSE-GRAINED HARDWOOD (OAK); AXIAL STATIONS FROM THE COLLAR FACE.",
        ...
        "SAND TO A COMFORTABLE GRIP.",
        "STAIN BLACK AND SEAL; THE BRASS COLLAR IS A SEPARATE PART (SEE ASSEMBLY).",
    )
)
