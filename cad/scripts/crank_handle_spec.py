...
DRAWING_NOTES = "\n".join(
    (
        ...
        "R256.00 ARC RUNS FROM COLLAR NECK AT 6.00 TO MAX AT 62.00; R56.02 ARC",
        "  RUNS FROM MAX TO BUTT FLAT AT 90.00. ARCS TANGENT AT MAX ONLY;",
        "  END JUNCTIONS ARE INTENTIONAL SHARP PROFILE TRANSITIONS.",
        "TURN COLLAR PROFILE INTEGRAL WITH HANDLE BLANK.",
        "BORE AXIS CONCENTRIC TO <MOD-DIAM>11.00 COLLAR OD WITHIN 0.10 TIR OVER COLLAR LENGTH.",
    )
)
