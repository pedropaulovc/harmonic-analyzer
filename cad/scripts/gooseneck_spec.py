...
DRAWING_NOTES = "\n".join(
    (
        "1. TUBE <MOD-DIAM>16.00 +/-0.10 X 2.0 WALL; CUT ENDS SQUARE.",
        "2. FORM CENTERLINE: 455 STRAIGHT LEG TO BEND TANGENT, R51",
        "   90-DEG BEND, THEN 61 STRAIGHT ARM TO END. LINEAR +/-0.5,",
        "   RADIUS +/-0.5, ANGLE +/-1 DEG; CENTERLINES COPLANAR 1 MAX.",
        "3. SILVER-BRAZE 5.5 X 13 X 3 LUG TO ARM UNDERSIDE: OUTER",
        "   EDGE 3 FROM ARM END; LUG TOP OVERLAPS TUBE 4.",
        "4. PIN <MOD-DIAM>4.00 +/-0.05 X 11; AXIS 4 ABOVE LUG BOTTOM,",
        "   OUTER END FLUSH WITH LUG OUTER EDGE; SILVER-BRAZE ALL ROUND.",
        "5. BEND OVALITY 5 PERCENT MAX; NO FLATS, KINKS OR CRACKS.",
    )
)
