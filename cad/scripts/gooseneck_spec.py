...
DRAWING_NOTES = "\n".join(
    (
        ...
        "3. SILVER-BRAZE 5.5 X 13 X 3 LUG TO ARM",
        "   UNDERSIDE. LUG OUTER EDGE 3 FROM ARM END;",
        "   LUG TOP OVERLAPS TUBE 4.",
        "4. PIN <MOD-DIAM>4.00 +/-0.05 X 11; AXIS 4 ABOVE LUG BOTTOM,",
        "   OUTER END FLUSH WITH LUG OUTER EDGE;",
        "   SILVER-BRAZE ALL ROUND.",
