...
DRAWING_NOTES = "\n".join(
    (
        ...
        "   455 STRAIGHT LEG TO BEND TANGENT, R51 90-DEG",
        "   BEND, 61 STRAIGHT ARM TO END. LINEAR +/-0.5;",
        "   RADIUS +/-0.5; ANGLE +/-1 DEG. LEG + ARM",
        "   CENTERLINES COPLANAR (ELEVATION PLANE) WITHIN 1.0.",
        "3. LUG: AISI 1018 BLANK 5.50 ALONG ARM X 10.50 HIGH",
        "   (PRE-COPE) X 3.00 THICK, CENTERED ON THE TUBE",
        "   CENTERLINE PLANE +/-0.25. COPE TOP TO TUBE OD",
        "   (COPE GOVERNS FINISHED HEIGHT); BRAZE TO ARM",
        "   UNDERSIDE; FREE-END FACE 3.00 FROM ARM END.",
        "4. PIN: AISI 1018, <MOD-DIAM>4.00 +/-0.05 X 11.00. AXIS",
        "   PARALLEL TO ARM, 4.00 ABOVE LUG BOTTOM, ON THE LUG",
        "   MID-THICKNESS PLANE +/-0.25. FREE-END FACE FLUSH",
        "   WITH LUG; EXTEND TOWARD BEND.",
        ...
        "   VOID LENGTH 0.50 MAX PER JOINT (VISUAL).",
