...
DRAWING_NOTES = "\n".join(
    (
        ...
        "3. LUG: AISI 1018, 5.50 ALONG ARM X 10.50 HIGH",
        "   X 3.00 THICK NORMAL TO ELEVATION. COPE TOP TO",
        "   TUBE OD; BRAZE TO ARM UNDERSIDE; FREE-END FACE",
        "   3.00 FROM ARM END.",
        "4. PIN: AISI 1018, <MOD-DIAM>4.00 +/-0.05 X 11.00.",
        "   AXIS PARALLEL TO ARM AND 4.00 ABOVE LUG BOTTOM.",
        "   FREE-END FACE FLUSH WITH LUG; EXTEND TOWARD BEND.",
        "5. SILVER-BRAZE LUG + PIN BAg-7 PER AWS A5.8.",
        "   FULL JOINT PENETRATION; 1.0 MIN FILLET ALL ROUND.",
        "   EXPOSED GAP 0.10 MAX; TOTAL VOID LENGTH 0.50 MAX.",
