...
# guide-screw through-holes live in platen_spec.py, which the clip, the guide
# rails and the paper-drive assembly read without importing this builder.
