...
DRAWING_NOTES = "\n".join(
    (
        "1. 1/4 IN (6.35) STEEL PLATE, BLACK OXIDE FINISH. DEBURR ALL EDGES.",
        "2. ASYMMETRIC WEDGE ABOUT THE CONE-AXIS LINE: EAST HALF-WIDTH TAPERS",
        "   12 -> 20, WEST HALF-WIDTH FLARES 9.5 -> 37 (SEE PLAN).",
        "3. PIVOT HOLE <MOD-DIAM>6.76 (1/4 CLEARANCE) THRU AT THE NORTH TIP,",
        "   7 FROM THE NORTH EDGE; PLATE SWINGS ON THE Ø6.35 PIVOT SCREW.",
        "4. LOCK NOTCH 8 WIDE OPENS THROUGH THE WEST EDGE FOR THE LOCK KNOB.",
        "5. PLAN CORNERS ROUNDED R8 - R12 AS MODELLED.",
    )
)
