...
DRAWING_NOTES = "\n".join(
    (
        "1. PLAN VIEW: PIVOT END IS NORTH; NOTCH SIDE IS WEST. CONE AXIS IS",
        "   THE CENTRELINE THROUGH PIVOT, NORMAL TO PARALLEL NORTH/SOUTH ENDS.",
        ...
        "   S EAST/WEST 20.00 +/-0.10 / 37.00 +/-0.10. APPLY TANGENT RADII.",
        "3. PIVOT HOLE <MOD-DIAM>6.756 +0.050/0 THRU ON CONE AXIS, 7.00",
        "   +/-0.10 SOUTH OF NORTH EDGE.",
        "4. LOCK NOTCH 8.000 +0.100/0 WIDE; FULL-R CLOSED END (R4.000 REF).",
