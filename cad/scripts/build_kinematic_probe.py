...
component moved by the coupled amount. Rotations are compared by MAGNITUDE (axis-angle
angle), never by projection onto a shared axis: the knob shaft is modeled on a spin
