...
DRAWING_NOTES = "\n".join(
    (
        ...
        "4. SUPPLY QTY 1 SCREW PER ASME B18.6.2 SQUARE-HEAD SET",
        "   SCREW PRACTICE: 1/4-20 UNC-2A X 16.00 UNDER-HEAD",
        "   LENGTH, THREADED FULL LENGTH (INCOMPLETE THREADS AT",
        "   HEAD 2 PITCH MAX); 10.00 +/-0.13 SQ X 6.00 +/-0.13",
        "   HEAD, CONCENTRIC TO SHANK WITHIN 0.25; FLAT POINT WITH",
        "   0.4 X 45-DEG LEAD CHAMFER; AISI 1018 STEEL, BLACK",
        "   OXIDE PER MIL-DTL-13924 CLASS 1.",
