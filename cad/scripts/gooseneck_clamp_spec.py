...
DRAWING_NOTES = "\n".join(
    (
        ...
        "4. SUPPLY QTY 1 SCREW: 1/4-20 UNC-2A X 16.00 UNDER-HEAD",
        "   LENGTH, FULLY THREADED; 10.00 +/-0.13 SQ X 6.00 +/-0.13",
        "   HEAD, CONCENTRIC TO SHANK WITHIN 0.25; FLAT POINT WITH",
        "   0.4 X 45-DEG LEAD CHAMFER; AISI 1018 STEEL, BLACK OXIDE.",
