...
tip-to-tip overall length (the profile's axis line) and the dome radius R3.  The outside diameter rides the stock
...
on the GD&T allowlist and nothing runs on it in service, so it carries no
