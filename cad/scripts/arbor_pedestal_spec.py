...
DRAWING_NOTES = "\n".join(
    (
        ...
        "2X STRAIGHT FLANKS RUN FROM THE DATUM-A FOOT CORNERS TO THE",
        "DIA 20.00 CROWN AT ITS HORIZONTAL CENTERLINE; NO TANGENCY.",
        "CROWN CENTER SHALL LIE WITHIN 0.05 OF THE BORE AXIS.",
        "FLANGE-HOLE AXIS IS BASIC 12.00 FROM DATUM B.",
        "STRAP 10.00 +/-0.10 THICK ALONG DEPTH. FACE OPPOSITE DATUM D",
        "IS COPLANAR WITH OPPOSITE FOOT FACE WITHIN 0.10.",
        "6.00 FROM DATUM D TO STRAP NEAR FACE IS REFERENCE ONLY.",
    )
)
