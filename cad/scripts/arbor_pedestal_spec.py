...
DRAWING_NOTES = "\n".join(
    (
        ...
        "PROFILE FCF TO A | B APPLIES TO CROWN, 2X FLANKS, FOOT TOP + RIGHT SIDE;",
        "DO NOT BREAK THE CROWN/FLANK OR FLANK/FOOT PROFILE JUNCTIONS.",
        "Ra 1.6 SYMBOL APPLIES TO ARBOR BORE ONLY.",
        "BOXED 12.00 LOCATES BOTH BORE AND FLANGE-HOLE AXES FROM DATUM B.",
        "BOXED 6.00 LOCATES STRAP NEAR FACE FROM D; PROFILE FCF TO A | B | D.",
        "BOXED 16.00 LOCATES COPLANAR FOOT/STRAP FAR FACES FROM D;",
        "PROFILE FCF TO A | B | D; RESULTING STRAP THICKNESS 10.00 REF.",
        "DIMENSIONS AND GD&T APPLY BEFORE COATING. MASK ARBOR BORE, DIA 3.26 HOLE,",
        "DATUM A/B/D FEATURES, AND ALL PROFILE-CONTROLLED SURFACES.",
        "APPLY 25-50 um TOTAL DFT OVER TWO COATS TO ALL OTHER SURFACES.",
    )
)
