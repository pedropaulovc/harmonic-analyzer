...
DRAWING_NOTES = (
    "MATCH EACH STUD TO ITS ASSIGNED MEASURED HANGER STACK; MEET THE "
    "ENGAGEMENT SHOWN ON SUMMING ASSEMBLY. CHAMFER TO EXISTING THREAD ROOT. "
    "KEEP AS SET. UNDIMENSIONED PURCHASED HEAD/THREAD GEOMETRY IS REFERENCE; "
