...
lower THREAD_LEN threads into the knife-mount top (tapped 1/2-13 x 12); the
plain shank rides the casting crossbar's O13.49 close-clearance bore; washer,
...
# concentric stack); the side view carries the shank/nut/tip lengths as the
# extrude DEPTH dimensions (named ShankLg/NutHt/TipLg in the build) -- an
# axis-along-Y stud projects edge-on circle silhouettes that SolidWorks will
# not point-select, so drawing-native edge dimensions cannot pick them.
