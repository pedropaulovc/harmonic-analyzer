...
DRAWING_NOTES = "\n".join(
    (
        ...
        "   +0.10/0.00 SQUARE THROUGH-HOLE THROUGH 12.00 HEIGHT;",
        "   INTERNAL CORNER R0.25 MAX. HOLE CENTERLINES WITHIN",
        "   0.10 OF BLOCK CENTERLINES.",
        "2. STRAP 3.00 THICK: 10.00 WIDE AT BLOCK, 16.00 AT TOP,",
        "   OVER 69.70 VERTICAL RISE. TOP-EDGE CENTER IS 8.00 LEFT",
        "   OF BLOCK CENTERLINE; DO NOT MIRROR. CENTER LOWER END",
        "   ON BLOCK WITHIN 0.10.",
        "3. SILVER-BRAZE WITH AWS A5.8 BAg-7; STRAP FLUSH WITH",
        "   BACK DEPTH FACE. CONTINUOUS 1.0 MIN FILLETS ACROSS FULL",
        "   10.00 WIDTH AT FRONT + BACK STRAP FACES; FULLY WETTED,",
