...
# shafts + 4 ball-mounts + 2 bushings per inter-channel gap), drive-train = 48 + N
...
# the ch25 pinion swing rig's 10: alignment-pinion, 2 brackets, 2 pivot
# blocks, pivot shaft, lift rod, lever, handle, return spring (PR4), + the PR2
# cone-swing hardware 6: lock knob, pivot screw, swing-stop screw, tip
...
# (164, 62 pre-PR2/PR4 -> 68) and stay correct at N=3.
_N_CH = _config.active_count()
_COMPONENT_BAND = {
    "frame": (11, 16),          # measured 13 (9 structure + 4 lag-screw hold-downs)
    "drive-train": (48 + _N_CH - 4, 48 + _N_CH + 4),  # N=20 -> (64,72), expected 68
