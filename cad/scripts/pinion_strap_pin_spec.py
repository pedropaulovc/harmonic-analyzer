...
from pinion_bracket_geometry import PIN_BORE, PIN_DROP, PIVOT_BORE, R_END, THICKNESS
...
SHAFT_LIGAMENT_WORST = SHAFT_LIGAMENT_CENTRED - DOT_XX_BAND
...
# both edges.
STRAP_FOOT_MIN_WIDTH = 2.0 * (R_END - DOT_X_BAND)
