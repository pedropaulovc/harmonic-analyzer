...
def test_cross_hole_matches_the_wizard_drill_and_build_station() -> None:
    ...
    source = _source()
    # Ø/THRU comes from the associative wizard callout with the drill as its
    # prefix (Harvey #13); a drawing-native end-face-to-hole-axis dimension
    # supplies the station under the block tolerance.
