...
DRAWING_NOTES = "\n".join(
    (
        "CYLINDRICAL BODY ONLY: FINAL LIMITS <MOD-DIAM>6.330-6.350, Ra 1.6;",
        "  NO FLATS OR STEPS. BODY LENGTH 192.00+/-0.25 BETWEEN CROWN BASE PLANES.",
        f"BOTH ENDS: SR{CAP_RADIUS:.2f} REF, 1.20+/-0.05 AXIAL CROWN; 194.40 OVERALL REF.",
    )
)
