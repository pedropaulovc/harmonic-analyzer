...
DRAWING_NOTES = "\n".join(
    (
        ...
        "   CMM: FIT LEAST-SQUARES CYLINDERS TO EACH EXPOSED OD ARC AND FULL BORE;",
        "   USE 8 EQUALLY SPACED AXIAL SECTIONS OVER 41.00, 8 EQUALLY SPACED",
        "   ACCESSIBLE-ARC POINTS/SECTION. AXIS OFFSET 0.05 MAX = GREATEST AXIS",
        "   SEPARATION AT EITHER END PLANE. RADIAL WALL = POINT-TO-BORE-AXIS",
        "   DISTANCE MINUS FITTED BORE RADIUS; MAX-MIN RADIAL WALL THICKNESS",
        "   SHALL NOT EXCEED 0.10 ACROSS ALL 64 OD POINTS. THIS CHECK IS ADDITIONAL",
        "   TO THE NATIVE SIZE AND POSITION CONTROLS.",
