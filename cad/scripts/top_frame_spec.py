...
DRAWING_NOTES = "\n".join(
    (
        ...
        "   <MOD-DIAM>0.20 A|B|C.",
        "5. BOSSES 4X <MOD-DIAM>48.00 +/-0.10; MAX-MIN RADIAL WALL THICKNESS",
        "   SHALL NOT EXCEED 0.10; CONTROLLED BY CIRCULAR RUNOUT OF EACH",
        "   BOSS OD TO ITS ASSOCIATED BORE AXIS.",
