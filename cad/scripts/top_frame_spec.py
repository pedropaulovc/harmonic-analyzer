...
DRAWING_NOTES = "\n".join(
    (
        "1. GRAY-IRON CASTING; AS-CAST SURFACES +/-0.8. MAY BE MACHINED FROM",
        "   SOLID ASTM A48 CLASS 30 STOCK; NO DRAFT MODELLED.",
        ...
        "4. GOOSENECK BORE <MOD-DIAM>17 THRU ONE RAIL AT MID-SPAN FOR THE",
        "   COUNTER-SPRING POST.",
    )
)
