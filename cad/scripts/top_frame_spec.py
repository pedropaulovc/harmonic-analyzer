...
DRAWING_NOTES = "\n".join(
    (
        ...
        "   4X FULL DIA48.00 BOSSES ON COLUMN-BORE AXES; NO BLENDS OR",
        ...
        "3. DATUM A = BOTTOM FACE; B = LEFT OUTER RAIL FACE; C = LOWER OUTER",
        "   RAIL FACE. LOWER-LEFT BORE AXIS BASIC 11.00 FROM B AND C; OTHERS",
        "   ON 394.00 X 224.00 BASIC RECTANGULAR PITCH.",
        "4. COLUMN BORES 4X <MOD-DIAM>25.50 +0.05/0 THRU; POSITION <MOD-DIAM>0.20 A|B|C.",
        "5. BOSSES 4X <MOD-DIAM>48.00 +/-0.10. IN EACH PLANE NORMAL TO ITS BORE",
        "   AXIS, MAX-MIN RADIAL WALL THICKNESS SHALL NOT EXCEED 0.10; INSPECT",
        "   BOSS CONTROLS BEFORE COATING.",
        "6. GOOSENECK BORE <MOD-DIAM>17.00 +0.20/0 THRU; AXIS BASIC ON",
        "   LEFT COLUMN-BORE CENTRELINE AND MIDWAY BETWEEN LEFT BORE AXES; POSITION",
        "   <MOD-DIAM>0.20 A|B|C. ALL BORES Ra 1.6.",
        "7. MASK DATUM A/B/C FACES, ALL BORES AND 4X BOSS ANNULI OD48.00/ID25.50.",
    )
)
