...
DRAWING_NOTES = "\n".join(
    (
        ...
        "   SEATS; CAST SURFACES ELSEWHERE, 1.5 MAX DRAFT. WEB/FLANGE T-ROOT",
        "   FILLETS R3 (BOTH SHELVES, ALL RAILS); TOP-FACE RIM EDGES C2.00 X 45",
        "   DEG (OUTER RING AND WINDOWS); ALL OTHER CAST EDGES INCL. BAND",
        "   BOTTOM RIM AND BOSS UNDERSIDES LEFT SHARP.",
