r"""Reproduction script: pivot shaft (book ch. 14 / ch. 17; 2 used).

Plain Ø6.35 (1/4") x 228.6 (9") steel shaft. One carries the 20 rocker
arms at machine (x, y) = (-72.9, 253.8); an identical one is the top
levers' common fulcrum at (-199.9, 1065.9). Each end seats in a
pivot-ball-mount's Ø6.5 cross-bore; pivot-bushing / lever-bushing
spacers set the 7.0565 channel pitch along it.
