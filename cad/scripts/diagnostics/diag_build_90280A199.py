r"""McMaster 90280A199 -- steel narrow fillister head slotted screw.
...
Run standalone (SolidWorks open)::
    ...
    uv run python cad\scripts\diagnostics\diag_build_90280A199.py
"""
...
async def build_90280A199(adapter, truth=None):
    await build_fillister(adapter, "90280A199")


if __name__ == "__main__":
    sys.exit(replica_main("90280A199", build_90280A199))
