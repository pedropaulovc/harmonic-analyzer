r"""McMaster 90280A196 -- steel narrow fillister head slotted screw.
...
Run standalone (SolidWorks open)::
    ...
    uv run python cad\scripts\diagnostics\diag_build_90280A196.py
"""
...
async def build_90280A196(adapter, truth=None):
    await build_fillister(adapter, "90280A196")


if __name__ == "__main__":
    sys.exit(replica_main("90280A196", build_90280A196))
