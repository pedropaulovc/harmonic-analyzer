...
Run standalone (SolidWorks open)::
    ...
    uv run python cad\scripts\diagnostics\diag_build_90280A194.py
"""
...
async def build_90280A194(adapter, truth=None):
    await build_fillister(adapter, "90280A194")


if __name__ == "__main__":
    sys.exit(replica_main("90280A194", build_90280A194))
