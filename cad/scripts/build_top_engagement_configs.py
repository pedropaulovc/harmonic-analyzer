...
(A fourth config, pinion_engaged, retired with the alignment-pinion -- the OD-62.2
re-anchor left no room for the drum; deferred for rework.)
...
# (pinion_engaged retired with the alignment-pinion; the OD-62.2 re-anchor left no
# room for the drum -- deferred for rework, so the top has 3 configs not 4.)
...
async def build(adapter: Any) -> dict[str, str]:
    ...
    # Final verification of all states after every change. rest LAST so the
