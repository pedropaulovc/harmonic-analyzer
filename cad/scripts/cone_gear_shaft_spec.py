...
# project's own DXF profile, cut with a self-made form cutter.  Forced-rebuild
# native BREP readback measures T006's minimum-material radius at 1.432434 mm
# and its as-cut radial tooth depth at 0.606907 mm.  A 1/16 in bore leaves a
# 0.638684 mm nominal web under that root, or 0.611184 mm at maximum bore, on
# a soldered, keyless, near-torque-free gear.  In exchange the 20.675 mm
# terminal journal goes from L/D 26 to 13 -- 16x the bending stiffness, the
# difference between a land a manual lathe can turn and one that whips off the
# tool.  The steps remain monotonically decreasing: the cone is assembled
# tip-first, and every gear OD exceeds the next inboard gear's bore
# (T006 4.08 > T012 bore 3.175;
