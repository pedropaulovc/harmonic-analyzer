...
DRAWING_NOTES = "\n".join(
    (
        ...
        "DIA 9.525 IS DATUM A. DIA 6.350 AND 3.175 CYLINDERS",
        "HAVE CIRCULAR RUNOUT 0.05 MAX TO A AT EVERY CROSS SECTION.",
        "SHOULDER ROOTS R0.10 MAX OR RELIEF 0.20 WIDE X 0.20 DEEP MAX.",
        "BREAK EXTERNAL EDGES 0.25 MAX.",
        ...
        "FINISH-TURN THE DIA 0.794 TIP LAST WITH FOLLOWER-REST SUPPORT --",
