...
DRAWING_NOTES = "\n".join(
    (
        "1. FINISHED LOWER FLANGE 12.70 THICK; UPPER PAD 444.50 X 266.70",
        "   X 38.10, CENTRED; TOTAL HEIGHT 50.80.",
        "2. CAST ALL WALLS 2 DEG DRAFT, ALL FILLETS/CORNERS R3.00; ALLOW 1.50",
        "   FOR MACHINING DATUM FACES A/B/C AND TOP PAD FACE.",
        "3. MACHINE A (UNDERSIDE) FLAT 0.10; B=LONG-SIDE EDGE; C=LEFT END;",
