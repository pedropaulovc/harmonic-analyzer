...
DRAWING_NOTES = "\n".join(
    (
        ...
        "   FOR EACH E1-E4, FIT LEAST-SQUARES CYLINDER AXES TO THE FULL",
        "   DIA 23.00 C'BORE AND DIA 13.00 THRU-HOLE SURFACES. AXIS",
        "   SEPARATION AT C'BORE MOUTH AND BOTTOM PLANES: 0.05 MAX.",
