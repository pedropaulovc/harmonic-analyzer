...
DRAWING_NOTES = "\n".join(
    (
        ...
        "   OR CAST FILLETS. LOWER FLANGE 12.70 THICK; TOTAL HEIGHT 50.80.",
        "2. UPPER PAD 444.50 X 266.70; PAD AND FLANGE CENTRELINES SHALL",
        "   COINCIDE WITHIN 0.20.",
        ...
        "   UNDERSIDE; C'BORE AXES WITHIN DIA 0.10 OF ASSOCIATED HOLE AXES.",
        "5. ALL OTHER TABLED HOLES ARE BLIND FROM TOP PAD FACE.",
    )
)
SIDE_VIEW_NOTE = "SIDE VIEW 1:4"
