...
DRAWING_NOTES = "\n".join(
    (
        ...
        "DECK IS A POCKET MILLED INSIDE THE RIM, COATED BLACK ENAMEL; RIM FLUSH WITH THE PAD SIDES.",
        "EXPOSED RIMS CHAMFERED 1/16 X 45 DEG; PAD ROOT FILLET R0.50; PLAN CORNERS CONCENTRIC.",
        "E1-E4 C'BORED FROM UNDERSIDE; OTHERS BLIND TAPPED. MASK UNDERSIDE + HOLES TO COAT.",
    )
)
