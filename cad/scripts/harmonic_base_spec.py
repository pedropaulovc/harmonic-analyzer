...
DRAWING_NOTES = "\n".join(
    (
        "1. TWO-PLATE BASE: 12.7 BOTTOM SLAB + 38.1 TOP PLATE, JOINED",
        "   AS ONE; 6.35 REVEAL PER LONG SIDE (SEE ISO). STACK 50.8.",
        "2. TOP PLATE 444.5 X 266.7 CENTRED ON THE 457.2 X 279.4 BASE.",
        "   GRAY IRON (ASTM A48 CLASS 30) OR EQUIV; DEBURR ALL EDGES.",
        "3. MOUNTING HOLES 4X <MOD-DIAM>13 THRU, C'BORE <MOD-DIAM>23 X 6.5",
        "   FROM UNDERSIDE FOR THE RECESSED LAG SCREWS (SEE TABLE).",
        "4. THREADED SEATS (#8-32, #4-40) TAPPED AT THE MODELLED",
        "   STATIONS PER THE CALLOUTS; LOCATIONS REFERENCE.",
    )
)
