...
DRAWING_NOTES = "\n".join(
    (
        "1. ONE-PIECE CASTING: 12.7 LOWER FLANGE + 38.1 UPPER PAD ARE",
        "   INTEGRAL; 6.35 REVEAL PER LONG SIDE. TOTAL HEIGHT 50.8.",
        "2. UPPER PAD 444.5 X 266.7 CENTRED ON 457.2 X 279.4 FLANGE.",
        "3. FOUR DIA 13 THRU / DIA 23 X 6.5 DEEP COUNTERBORES OPEN",
        "   FROM UNDERSIDE; OTHER TABLED SEATS ARE BLIND FROM THE TOP FACE.",
        "4. TOP-SIDE SEAT X/Y LOCATION TOLERANCE +/-0.25; SEE TABLE.",
    )
)
