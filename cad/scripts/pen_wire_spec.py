...
DRAWING_NOTES = "\n".join(
    (
        ...
        "2. END-FACE AXIAL VARIATION ACROSS DIA 0.05 MAX. THE",
        "   TITLE-BLOCK R0.25/CHAMFER 0.25 LIMIT DOES NOT APPLY TO",
        "   WIRE ENDS; END EDGE R0.05 MAX.",
        "3. LAY FREE WIRE ON A FLAT SURFACE PLATE; 0.50 MAX GAP",
        "   BETWEEN CYLINDRICAL SURFACE AND PLATE OVER FULL LENGTH.",
