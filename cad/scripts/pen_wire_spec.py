...
DRAWING_NOTES = "\n".join(
    (
        ...
        "2. CUT ENDS SQUARE; REMOVE LOOSE BURRS WITHOUT REDUCING DIA.",
        "3. STRAIGHTNESS 0.50 MAX OVER FULL LENGTH; NO KINKS OR",
        "   PERMANENT SET. FORM + TERMINATE ENDS AT ASSEMBLY.",
    )
)
