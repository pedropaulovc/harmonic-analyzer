...
async def build(adapter: Any) -> dict[str, str]:
    ...
    add_datum_feature(
        ...
        # The tag stands only 18 mm off the bore edge, so a snap-back onto the
        # attachment would pass the default bound; the live readback is
        # 0.0020 mm from the request.
