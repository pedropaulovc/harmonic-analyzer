...
DRAWING_NOTES = "\n".join(
    (
        ...
        "CUT TEETH PER GEAR DATA; DEBUR ALL EDGES.",
        "GEAR PITCH AXIS CONCENTRIC WITH BORE: 0.05 TIR.",
        f"ECCENTRIC CAM (FAR FACE): Ø{CAM_DIA:.1f}, {CAM_THICKNESS:.1f} THK",
        f"  BEYOND GEAR FACE, AXIS OFFSET {ECCENTRICITY:.2f} FROM BORE (NOTCH SIDE).",
        f"NOTCH: {NOTCH_WIDTH:.1f} WIDE X {NOTCH_DEPTH:.1f} RADIAL DEEP, TOOTH VALLEY AT TOP.",
        "20 REQUIRED, ALL IDENTICAL.",
    )
)
