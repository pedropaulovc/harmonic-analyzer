...
DRAWING_NOTES = "\n".join(
    (
        ...
        "ALL THREE BORES DRILLED THRU ALONG THE DEPTH FROM THE FRONT FACE.",
        "2X CLAMP-SCREW #8 CLEARANCE HOLES FLANK THE COLUMN: HEADS ON THE",
        "FRONT FACE, SHANKS THROUGH THE FRONT ARC INTO THE BACK ARC (MHA-106).",
        "1X PEN-HANGER #6 CLEARANCE HOLE AT THE FREE END.",
