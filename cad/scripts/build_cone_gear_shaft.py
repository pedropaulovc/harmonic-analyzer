...
* 1/16 in x 138.9788 -- T006 seat and tip journal; contacts the exact
  ...
  gear seat; at L/D 21 that land could not be turned in steel.  1/16 in is
  the largest step the T006 rim tolerates (0.543 mm under the as-cut
  base-chord root) and leaves L/D 10 -- see cone_gear_shaft_spec.SECTIONS.
