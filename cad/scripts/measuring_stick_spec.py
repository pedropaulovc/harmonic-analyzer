...
DRAWING_NOTES = "\n".join(
    (
        ...
        "   EACH FULL TICK 3.00 LONG X 0.40 WIDE X 0.50 DEEP, FROM",
        "   THE TOP EDGE. ADD ONE HALF-DIVISION TICK 4.00 FROM TICK 0;",
        "   HALF TICK 4.00 LONG X 0.40 WIDE X 0.50 DEEP.",
        "3. STAMP 2.0-HIGH NUMERALS 0 THRU 10 BELOW FULL TICKS; READ",
        "   LEFT TO RIGHT AS SHOWN. BLACK-FILL ALL TICKS + NUMERALS.",
    )
)
