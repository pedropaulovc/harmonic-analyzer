...
DRAWING_NOTES = "\n".join(
    (
        ...
        "2. ENGRAVE 11 FULL TICKS (VALUES 0 THRU 10) AT 8.00 PITCH.",
        "   SQUARE-BOTTOM SLOTS 3.00 +/-0.10 LONG X 0.40 +/-0.05",
        "   WIDE X 0.50 +/-0.05 DEEP FROM BOTTOM EDGE SHOWN.",
        "   ONE HALF-DIVISION TICK BETWEEN 0 + 1: SAME SLOT,",
        "   4.00 +/-0.10 LONG.",
        "3. ENGRAVE 2.00 +/-0.10 HIGH ASME Y14.2 VERTICAL GOTHIC",
        "   NUMERALS. CENTER EACH ON ITS FULL TICK; NUMERAL BOTTOM",
        "   4.50 +/-0.10 ABOVE BOTTOM EDGE. DEPTH 0.20 +/-0.05.",
        "   READ 0 THRU 10 LEFT TO RIGHT. BLACK-FILL ALL ENGRAVING.",
    )
)
