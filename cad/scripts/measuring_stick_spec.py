...
DRAWING_NOTES = "\n".join(
    (
        ...
        "   STICK READS ORDINATE, NOT MM: GRADUATE FROM THE STATION",
        "   TABLE IN READOUT.MD (RELEASE BUNDLE), WHICH ALSO GIVES",
        "   THE NULL-LIFT AND 2ND-HARMONIC CORRECTIONS. SET EACH BAR",
