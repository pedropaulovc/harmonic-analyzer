...
DRAWING_NOTES = "\n".join(
    (
        ...
        "   IS THE DATUM: TICK N AT 8.00 X N FROM THE 0 TICK,",
        "   EACH WITHIN +/-0.05 OF ITS OWN POSITION",
        "   (NONCUMULATIVE; 0-TO-10 SPAN 80.00 REF).",
        ...
        "   LEFT TO RIGHT. BLACK-FILL ALL ENGRAVING: FLAT BLACK",
        "   ENAMEL WIPE-FILLED, CURED BEFORE FINAL POLISH.",
        "4. NUMERALS + TICK VALUES ARE SHOWN OFFSET BELOW THE",
        "   BAR FOR LEGIBILITY; ENGRAVE ON THE RULED FACE PER",
        "   NOTES 2 + 3.",
    )
)
