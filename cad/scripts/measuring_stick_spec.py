...
DRAWING_NOTES = "\n".join(
    (
        ...
        "5. SETTING: THE 0 TICK IS CALIBRATED ON THE ASSEMBLED",
        "   MACHINE AT THE NULL STATION (TOLERANCE POLICY). SET EACH",
        "   BAR BY INTERPOLATING TO 1/5 MINOR DIVISION (0.28);",
