...
_ALLOWED_FREE_STEMS: dict[str, tuple[str, ...]] = {
    ...
    "drive-train": (
        ...
        "crank-chain-eyelet", "crank-drive-gear", "crank-handle",
        "crank-pin", "crank-pin-ring", "crank-pinion", "crankshaft",
        "cylinder-gear", "fillister-screw", "pinion-arbor", "pinion-bracket",
        "pinion-cam", "pinion-cam-pin", "pinion-handle", "pinion-lever",
        "pinion-lift-rod",
    ),
    "magnifier": (
