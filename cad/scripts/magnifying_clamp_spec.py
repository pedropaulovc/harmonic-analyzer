...
DRAWING_NOTES = "\n".join(
    (
        "LEVER BORE Ø6.2 THRU (ALONG DEPTH): SLIP FIT ON THE Ø6 MAGNIFYING LEVER.",
        ...
        "THUMB-SCREW HOLE #4-40 TAPPED THRU FROM THE TOP INTO THE LEVER BORE;",
        "THE SCREW CLAMPS THE BLOCK AT THE SET MAGNIFICATION.",
    )
)
