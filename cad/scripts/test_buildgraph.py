...
_INSERTED_SOURCES = {
    ...
    "crank_pin_eye crank_pin_ring crank_pinion crankshaft cylinder_end_disc "
    "cylinder_gear cylinder_gear_shaft dome_cap_screw fillister_screw foot_screw "
    "pinion_arbor pinion_bracket pinion_cam pinion_cam_pin pinion_handle "
    "pinion_handle_pin pinion_lever pinion_lift_rod pinion_pivot_block "
    "pinion_pivot_shaft pinion_spring "
    "slotted_screw swing_stop_screw",
