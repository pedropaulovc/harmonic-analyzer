...
DRAWING_NOTES = "\n".join(
    (
        ...
        f"CENTRE {CENTER_Y - PIVOT_MID_Y:.2f} ABOVE PIVOT AXIS ON ITS VERTICAL C/L;",
        "SYMMETRIC ENDS; ROD-PIN HOLE AT END SHOWN ONLY.",
        f"HUB DIA {HUB_DIA:.2f} X {HUB_LENGTH:.2f}; SETS STATION PITCH; NO SPACERS.",
    )
)
