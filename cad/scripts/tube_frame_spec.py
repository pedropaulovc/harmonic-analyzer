...
DRAWING_NOTES = "\n".join(
    (
        "ROUGH-CUT OVERSIZE; MATCH-MARK EACH COLUMN,",
        "CORNER AND ORIENTATION.",
        "FIT BASE MHA-035 AND TOP FRAME MHA-077;",
        "SET TOP CROSS-BORE AXIS HEIGHT PER FRAME",
        "ASSEMBLY DRAWING. MAINTAIN HEIGHT DURING FIT.",
        "FINAL MATCH-CUT EACH IDENTIFIED TUBE TO THE",
        "ACTUAL BASE/TOP/CAP STACK: MHA-133 CAPS",
        "FULLY SEATED, SKIRTS CLEAR OF RECESS FLOORS.",
        "DO NOT TRIM CAPS.",
        "FINISH TOP CHAMFER AFTER FINAL MATCH-CUT;",
        "THEN MATCH-DRILL UPPER STATION AT SET HEIGHT.",
        "MATCH-DRILL WITH BASE MHA-035 AND TOP MHA-077",
