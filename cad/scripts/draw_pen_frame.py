...
async def build(adapter: Any) -> dict[str, str]:
    ...
    # On this first-angle sheet, the left-side view belongs to the right of the
    # front view.  Hidden lines show the blind-to-window thread path.
    ...
    add_property_linked_note(adapter, "Left View Note", 0.184, 0.105)
