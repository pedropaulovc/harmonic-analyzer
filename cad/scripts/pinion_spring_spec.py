...
DRAWING_NOTES = "\n".join(
    (
        ...
        "FRONT PROFILE IS STRIP NEUTRAL AXIS; R2.00 AND R1.50 ARE NEUTRAL-AXIS RADII.",
        f"STRAIGHT BLADE TANGENT LENGTH {BLADE_STRAIGHT_LEN:.2f}+/-0.10; BLADE AXIS",
        "  77.62+/-1.00 DEG FROM FOOT PLANE (12.38 DEG FROM ITS NORMAL).",
        "KINK CHANGES TANGENT 20.00+/-1.00 DEG TOWARD FOOT; FREE FLAT TRUE LENGTH 2.00+/-0.10.",
        "FOOT 31.00+/-0.10 TRUE LENGTH, FREE END TO R2 TANGENCY. HOLE",
        "  <MOD-DIAM>3.25+/-0.05, 3.10+/-0.10 FROM FREE END, CENTRED IN 4.00 WIDTH +/-0.05.",
        "ALL BENDS COPLANAR. FOOT MOUNTING FACE FLATNESS 0.10; BLADE FACE TOWARD STRAP Ra 0.8.",
    )
)
