...
# function).  MHA-102's float model (pinion_arbor_geometry) is the evidence:
# the straps are pinned to the torque shaft at the drum plus the drilling
# shim, the drum's end play is split any way between its two ends, and "the
# drum hard forward and hard aft are the two stops" -- a drum end face meets
# a strap's inner face.  The drum turns
