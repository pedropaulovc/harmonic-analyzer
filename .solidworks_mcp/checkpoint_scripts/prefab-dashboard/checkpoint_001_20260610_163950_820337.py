...
CHECKPOINT_INDEX = 1
CHECKPOINT_TITLE = 'Base profile'
PLANNED: dict[str, Any] = json.loads('{"title": "Base profile", "goal": "Create the base sketch profile", "tools": ["create_sketch", "add_line"], "rationale": "Establish the primary profile before any 3D feature."}')
