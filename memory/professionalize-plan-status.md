...
**DONE (pushed to main):**
- A (prune comparisons to ch30 8-views), B1 (retire C#/KCL), B2 (README + cad/docs/), C (YAML config layer + `_config.py` + generated DIMENSIONS.md from dimensions.yaml), E (gitignore binaries).
