...
Write-Host ""
Write-Host "On each machine, set (PowerShell):"
Write-Host "    `$env:HARMONIC_CACHE_ACCOUNT   = '$StorageAccount'"
Write-Host "    `$env:HARMONIC_CACHE_CONTAINER = '$Container'"
Write-Host "    `$env:HARMONIC_CACHE_SALT      = 'sw2024-sp3'   # bump on a SolidWorks upgrade"
Write-Host "    `$env:HARMONIC_CACHE_MODE      = 'ro'           # dev: pull only"
Write-Host "    `$env:HARMONIC_CACHE_MODE      = 'rw'           # builder (vm-solidworks): pull + push"
Write-Host ""
