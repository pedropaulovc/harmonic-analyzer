...
Write-Host "Downgrade a seat only if you want to (gitignored file; or HARMONIC_REMOTE_CACHE_MODE):"
Write-Host "    Set-Content .harmonic-remote-cache-mode ro    # pull only"
Write-Host "    Set-Content .harmonic-remote-cache-mode off   # disable"
Write-Host ""
