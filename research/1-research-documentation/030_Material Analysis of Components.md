# Material Analysis of Components
...
Review the images in the pdf carefully and make your best guess of what materials are used for each one of the components. Mention at least the components below. For each material, make sure to describe the most probable alloy used. A list of common alloys is provided at the end.

1. Power and Input Components
Crank
...
2. Frequency Generation Components
Cone Gear Set

20 conically arranged spur gears

Central shaft

Pivot mechanism

Adjustment knob and fasteners

Cylinder Gear Set

20 cylindrical gears
...
Mounting axle and support structure

3. Motion Transmission Components
Rocker Arms
...
Connecting rods from cylinder gears

Amplitude Bars

20 amplitude adjustment bars
...
4. Summation Components
Summing Lever

One main summing lever
...
5. Magnification Components
Magnifying Lever

Magnifying lever arm

Sliding fixture and locking screw

Connecting wire

Magnifying Wheel

Dual-wheel magnifying pulley:
...
6. Output and Recording Components
Platen Mechanism
...
6 translational gears

Rack and pinion gears

Gear set

Chain or linkage for gear switching
...
Vertical rod attachment

Adjustment set screw

7. Calibration and Alignment Components
Measuring Stick

Brass measuring stick

Sliding stop

Pinion Gear for Alignment

Small pinion gear

Lever mechanism for gear alignment

Reference notch alignment features

8. Structural and Miscellaneous Components
Base and Frame

Heavy metal baseplate

Vertical spine support

Support structure and frame elements
...
Here's a precise, technically-oriented assessment of the most probable materials and alloys used for the specified components based on their functions, typical engineering practices of the late 19th and early 20th centuries, and visual inspection of provided images from Michelson’s Harmonic Analyzer documentation:

---

### 1. Power and Input Components
- **Crank:** Likely **Steel**, possibly **Low Carbon (A36)** for durability, toughness, and ease of machining.
- **Handle:** **Wood**, possibly hardwood, stained black for grip comfort and thermal insulation.
- **Crankshaft:** **Alloy Steel 4130 or 4140**, heat-treated for high strength and fatigue resistance.
- **Tapered pin:** **Stainless Steel 304 or 416** for corrosion resistance and machinability.

---

### 2. Frequency Generation Components
- **Cone Gear Set:**
  - **20 conically arranged spur gears:** Likely **Brass (C360)** for machinability and minimal friction.
  - **Central shaft:** **Steel 4130 or 4140**, due to required rigidity and durability.
  - **Pivot mechanism:** **Brass 260 or Bearing Bronze (C932)**, due to excellent wear properties.
  - **Adjustment knob and fasteners:** **Brass (C360)** or **Stainless Steel 303** for ease of machining and adjustment durability.

- **Cylinder Gear Set:**
  - **20 cylindrical gears:** **Brass (C360)**, consistent with historical gear manufacturing practice.
  - **Connecting rods:** **Alloy Steel 4130 or 4140**, thin and rigid, providing stable reciprocating motion.
  - **Cams:** **Brass (C360)** or **Steel 4130**, hardened surfaces preferred for precise, wear-resistant cam surfaces.
  - **Alignment notches:** Machined into gears; no additional material.
  - **Mounting axle/support structure:** **Steel (A36)** for structural integrity and cost-effectiveness.

---

### 3. Motion Transmission Components
- **Rocker Arms:**
  - **20 rocker arms:** **Alloy Steel 4130 or 4140**, ensuring rigidity and dimensional stability.
  - **Pivots:** **Bearing Bronze (C932)** or **Stainless Steel 416** to minimize friction and wear.
  - **Connecting rods from cylinder gears:** **Steel 4130** for strength and minimal flex.

- **Amplitude Bars:**
  - **20 amplitude adjustment bars:** Likely **Chrome-plated Steel (4130)** to reduce corrosion and improve surface finish for smooth sliding.
  - **Positioning notches:** Machined directly into steel bars.

- **Springs and Levers:**
  - **20 small lever arms:** **Steel 4130 or Stainless Steel (316/316L)**, for rigidity and fatigue resistance.
  - **20 tension springs:** **Spring Steel (Stainless 302 or 17-4 PH)**, known for elastic resilience.
  - **Pivots and fulcrums:** **Bearing Bronze (C932)** or **Stainless Steel 416**.

---

### 4. Summation Components
- **Summing Lever:** **Alloy Steel 4130 or 4140**, optimized for minimal flex.
- **Spring attachment points:** **Steel 4130** for structural reliability.

- **Counter Spring:**
  - **One large spring:** **Spring Steel (17-4 PH)**, known for durability and consistent spring characteristics.
  - **Curved, tapered post:** **Brass (C360)** or **Stainless Steel 303** for adjustability and machinability.
  - **Adjustment screw:** **Stainless Steel 303**, durable and easily machined.

---

### 5. Magnification Components
- **Magnifying Lever:**
  - **Lever arm:** **Brass (C360)** or **Steel 4130**, balancing stiffness and machinability.
  - **Sliding fixture and locking screw:** **Brass (C360)** or **Stainless Steel 303** for smooth adjustment.
  - **Connecting wire:** Likely **Steel cable or piano wire** for consistent tensile performance.

- **Magnifying Wheel:**
  - **Small inner wheel:** **Brass (C360)**, precision machined.
  - **Large outer wheel:** **Brass (C360)** or **Stainless Steel 303**, precision machined for stable rotation.
  - **Precision-machined bearing:** **Bearing Bronze (C932)** or **Stainless Steel (416)**.
  - **Attachment wires:** **Steel piano wire** for minimal stretch and reliable performance.

---

### 6. Output and Recording Components
- **Platen Mechanism:**
  - **Heavy brass platen:** **Brass (C360)** for weight, stability, and corrosion resistance.
  - **Brass rack:** **Brass (C360)**, reliable for precise gear engagement.
  - **Paper clips:** **Brass (C360)** or **Spring Steel (17-4 PH)**.

- **Translational Gearing:**
  - **6 translational gears:** **Brass (C360)** for smooth engagement.
  - **Rack and pinion gears:** **Brass (C360)** for consistent performance.
  - **Gear set:** Interchangeable **Brass (C360)** gears.
  - **Chain or linkage for gear switching:** **Steel chain**, possibly nickel-plated.
  - **Engagement latch:** **Brass (C360)** or **Stainless Steel 303**.

- **Pen Mechanism:**
  - **Brass frame:** **Brass (C360)** for machinability.
  - **Marker holder:** **Brass (C360)** or Delrin (Acetal) if low friction is desired.
  - **Vertical rod attachment:** **Brass or Steel 4130**, precision machined.
  - **Adjustment set screw:** **Stainless Steel 303 or Brass (C360)**.

---

### 7. Calibration and Alignment Components
- **Measuring Stick:**
  - **Brass measuring stick:** **Brass (C360)**, hand-machined and stamped for precision marking.
  - **Sliding stop:** **Brass (C360)**, ensuring accurate, repeatable positioning.

- **Pinion Gear for Alignment:**
  - **Small pinion gear:** **Brass (C360)**, minimal wear in alignment tasks.
  - **Lever mechanism for gear alignment:** **Brass (C360)** or **Stainless Steel 303**.
  - **Reference notch alignment:** Machined directly into gears.

---

### 8. Structural and Miscellaneous Components
- **Base and Frame:**
  - **Heavy metal baseplate:** Likely **Steel (A36)**, cast or machined.
  - **Vertical spine support:** **Steel (A36 or 4130)** for rigidity.
  - **Support structure/frame elements:** Primarily **Steel (A36 or 4130)**, possibly painted or lacquered for corrosion protection.

- **Nameplate:** **Brass (C260 or C360)**, engraved for aesthetic and durability.

---

### **Summary of Predominant Alloys:**
- **Brass (C360):** gears, mechanisms, components requiring machinability.
- **Steel (4130, A36):** structural rigidity, crankshafts, levers, and connecting rods.
- **Bearing Bronze (C932):** pivots, bearings, low friction parts.
- **Spring Steel (17-4 PH):** springs, elastic components.
- **Stainless Steel (303, 304, 416):** pins, screws, fasteners for corrosion resistance and strength.

These selections are consistent with period manufacturing capabilities, mechanical requirements, and visible indications from the Michelson Harmonic Analyzer’s construction details.
...
build a table listing all components with two columns to identify the ones that can be machined using a 3 axis and a 4 axis cnc mill 
...
Here's a clear table identifying components from Michelson’s Harmonic Analyzer based on machining suitability for 3-axis and 4-axis CNC mills:

| Component                          | 3-Axis CNC Mill | 4-Axis CNC Mill |
|------------------------------------|-----------------|-----------------|
| **Power and Input Components**     |                 |                 |
| Crank                              | ✓               | ✓               |
| Handle                             | ✓               | ✓               |
| Crankshaft                         | ✗               | ✓               |
| Tapered pin                        | ✓               | ✓               |
...
| Pivot mechanism                    | ✓               | ✓               |
| Adjustment knob and fasteners      | ✓               | ✓               |
| 20 Cylinder Gears                  | ✓ (simple profiles only) | ✓ (complex profiles) |
| Connecting rods                    | ✓               | ✓               |
| Cams                               | ✓ (limited complexity) | ✓ (preferred) |
| Alignment notches                  | ✓               | ✓               |
| Mounting axle & supports           | ✓               | ✓               |
| **Motion Transmission Components** |                 |                 |
| 20 Rocker arms                     | ✓ (simplified)  | ✓ (complex curvature) |
| Pivots                             | ✓               | ✓               |
| Connecting rods from gears         | ✓               | ✓               |
| 20 Amplitude Bars                  | ✓               | ✓               |
| Positioning notches                | ✓               | ✓               |
| 20 small lever arms                | ✓               | ✓               |
| 20 tension springs                 | ✗ (typically specialized) | ✗ (specialized) |
| Pivots and fulcrums                | ✓               | ✓               |
| **Summation Components**           |                 |                 |
| Summing lever                      | ✓ (simplified geometry) | ✓ (complex geometry) |
| Spring attachment points           | ✓               | ✓               |
| Counter spring                     | ✗ (spring forming required) | ✗ (spring forming required) |
| Curved, tapered post               | ✓               | ✓ (optimal)      |
| Adjustment screw                   | ✓               | ✓               |
| **Magnification Components**       |                 |                 |
| Magnifying lever arm               | ✓               | ✓               |
| Sliding fixture & locking screw    | ✓               | ✓               |
| Connecting wire                    | ✗ (standard component) | ✗ (standard component) |
| Magnifying Wheel: Small inner wheel| ✓               | ✓               |
| Magnifying Wheel: Large outer wheel| ✓               | ✓               |
| Precision-machined bearing         | ✓               | ✓               |
| Attachment wires                   | ✗ (standard component) | ✗ (standard component) |
| **Output and Recording Components**|                 |                 |
| Heavy brass platen                 | ✓               | ✓               |
| Brass rack                         | ✓               | ✓               |
| Paper clips                        | ✓               | ✓               |
| 6 translational gears              | ✓               | ✓               |
| Rack and pinion gears              | ✓               | ✓               |
| Gear set (interchangeable)         | ✓               | ✓               |
| Chain/linkage                      | ✗ (standard component) | ✗ (standard component) |
| Engagement latch                   | ✓               | ✓               |
| Brass frame (pen mechanism)        | ✓               | ✓               |
| Marker holder                      | ✓               | ✓               |
| Vertical rod attachment            | ✓               | ✓               |
| Adjustment set screw               | ✓               | ✓               |
...
| Sliding stop                       | ✓               | ✓               |
| Small pinion gear                  | ✓               | ✓               |
| Lever mechanism for alignment      | ✓               | ✓               |
| Reference notch alignment features | ✓               | ✓               |
| **Structural & Miscellaneous**     |                 |                 |
| Heavy metal baseplate              | ✓               | ✓               |
| Vertical spine support             | ✓               | ✓               |
| Support structure/frame elements   | ✓               | ✓               |
| Nameplate                          | ✓               | ✓               |

**Legend:**
- **✓** = Suitable for this type of CNC machining.
- **✗** = Not suitable or specialized component.

Generally, the main advantage of the **4-axis CNC mill** over a **3-axis CNC mill** is the capability to machine complex profiles (especially gears and cams) and operations requiring rotational indexing without repositioning parts manually.
