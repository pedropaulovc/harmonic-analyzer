...
| C | **Counter-spring gooseneck square-head pinch screw** — pinches the adjustable post in its socket | ch19 p.45 "square-head screw pinches the post"; dims 10×10×6 head, Ø5 shank | 1 | **square head**, slotless | **³⁄₁₆″** square-head | ◐ | modeled as the discrete `gooseneck-screw` part, seating on the top frame's own tapped socket boss |
