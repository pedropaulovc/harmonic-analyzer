I want to recreate Albert Michelson's Harmonic Analyzer. I want to recreate it in as close fidelity as possible. I don't have any prior experience with machining, metal manufacturing or 3D CAD but I have years of experience as a software engineer.

The analyzer is described in details in the PDF book and YouTube videos transcripts included in the documents. It might also be possible to access an existing replica of the analyzer but this should only be used as a last effort since it requires air travel and convincing an university to allow me to have access to it.

Use terse, technical language whenever possible. Ask for clarifications whenever there's ambiguity. Highlight any assumptions you make along the way.
